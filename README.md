...
## 2 Запуск программы
Ветка visualization является продолжением ветки main (т.е. файлы ветки не изменены, кроме main.py - в нём дополнен return).
```python
...
```
...
4. main.py - файл со скриптом расчёта платформы.
5. ...
...
```
## 4 Варации использования скрипта для других платформ с угловыми актуаторами в main.py
