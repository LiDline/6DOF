...
2. Проверку полученных углов можно совершить в SW/AST-5.2.0-A1-scetch.SLDASM. Sketch "Рычаг[i+1]" = углу актуатора. На рисунке 2, а мы видим, что угол равен 55.89 град (что совпадает с solve(25, 25, 300, 5, 5, 5)[0] - в SW отрицательных углов нет). В Sketch "Угол шаровой[i+1]-1 или 2" можно увидеть угол шаровой опоры.
